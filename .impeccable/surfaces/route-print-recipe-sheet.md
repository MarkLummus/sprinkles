...
2. **Method page.** The ten steps in page order: bold lead-in, prose instruction, typed target chips beside the prose (PRINT-02). "Before you start" heads the method and is closed by a hairline rule, as on screen.
