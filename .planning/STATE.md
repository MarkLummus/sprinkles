...
Last activity: 2026-09-16 - Completed quick task 260916-xbh: the churn date is named required and its refusal renders once (critique fix 2); fixes 2, 3, 4 and 5 now closed, fix 1 deferred to the page shell's brief
