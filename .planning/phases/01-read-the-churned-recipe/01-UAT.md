...
updated: 2026-09-06T02:53:38Z
---

## Current Test

number: 1
name: Open http://localhost/ after `npm --prefix app run dev`. Confirm the list shows one recipe (Olive Oil Ice Cream, 50 g oil · 800 g, 799.7 g); click through to /recipe/olive-oil-ice-cream-v1; reload twice and confirm still exactly one recipe.
expected: |
  List renders the seeded recipe; navigation and reload behave as described; no duplicate seeding.
