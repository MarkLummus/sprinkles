...
updated: 2026-09-07T00:23:01Z
---

## Current Test

number: 1
name: The new-batch door and the unknown-address wording
expected: |
  "Record another batch" appears after the batch list, reads distinctly from "Amend", and opens the pen layer with an empty draft. The unknown-batch-id URL (/recipe/olive-oil-ice-cream-v1/batch/does-not-exist) shows the "No batch of this version has that address." sentence, never the zero-batch sentence.
