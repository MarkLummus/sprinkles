...
- **Batch row:** a region-name head line with the churned date in pen blue beside it, then a wrapping grid of measured cells — label in caption face, figure in pen blue at the note size and the prose weight (sketch 008, 2026-09-14: a recorded value reads at the weight of the maker's words; the balance figure keeps figure size and 700 in ink), unit at the deviation size, plan sub-line in small print. Correct sits on the head line, right-aligned, as a text control (sketch 003, 2026-09-14; Add tasting lives inside the reopened pen, 03.3.1 D-01/D-03); earlier batches open as a hairline-ruled panel beneath.
