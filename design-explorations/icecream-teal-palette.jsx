...
export default function TealCreamPalette() {
  ...
  // Color tokens - Teal + Cream
  const colors = {
    // Cream backgrounds
    bgPage: '#FDFCF9',        // Soft cream
    bgCard: '#FFFFFF',
    bgCardAlt: '#F7F5F0',     // Warm cream gray
    bgHover: '#F2EFE8',
    ...
    // Text - warm neutrals
    textPrimary: '#2D3A3A',   // Deep teal-gray
    textSecondary: '#526060',
    textMuted: '#8A9696',
    
    // Teal accent - the star
    teal: '#2A9D8F',          // Transformative teal
    tealLight: '#E6F5F3',     // Light teal bg
    tealDark: '#1E7268',      // Darker teal for hover
    tealMuted: '#4DB8AC',     // Mid teal
    
    // Coral accent (warm complement)
    coral: '#E07A5F',
    coralLight: '#FDF0EC',
    
    // Status colors
    success: '#2A9D8F',       // Use teal for success
    warning: '#E9C46A',       // Warm yellow
    warningDark: '#C9A227',
    error: '#E07A5F',         // Use coral for errors
  };
      ...
      <header style={{ backgroundColor: colors.bgCard, borderColor: colors.border }} className="border-b px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <div style={{ background: `linear-gradient(135deg, ${colors.teal} 0%, ${colors.tealDark} 100%)` }} className="w-8 h-8 rounded-lg flex items-center justify-center">
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="relative">
            <button 
              ...
              style={{ background: `linear-gradient(135deg, ${colors.teal} 0%, ${colors.tealDark} 100%)` }}
            >
              Save
              <ChevronDown className="w-3.5 h-3.5" />
            </button>
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              <div className="flex items-center gap-3">
                <span style={{ backgroundColor: colors.tealLight, color: colors.tealDark }} className="px-2.5 py-1 text-xs font-medium rounded-full font-sans">
                  🧊 Gelato
                </span>
              ...
              {[
                ...
                <div key={item.label} className="w-32">
                  ...
                  <div style={{ backgroundColor: colors.bgCardAlt }} className="h-2 rounded-full overflow-hidden">
                    <div 
                      style={{ background: `linear-gradient(90deg, ${colors.tealMuted} 0%, ${colors.teal} 100%)` }}
                      className="h-full rounded-full transition-all" 
                      // Inline width for demo
                    />
                  </div>
                </div>
              ))}
          ...
          <div style={{ backgroundColor: colors.bgCard, borderColor: colors.border }} className="col-span-2 rounded-xl border shadow-sm overflow-hidden">
            <div style={{ borderColor: colors.borderLight }} className="px-5 py-3 border-b flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <button className="text-sm font-sans" style={{ color: colors.teal }}>
                  + Add ingredient
                </button>
              </div>
            </div>
            <table className="w-full text-sm font-sans">
              ...
              <tbody style={{ color: colors.textPrimary }}>
                {[
                  ...
                  { name: 'Cream, heavy', category: 'Fat', categoryBg: '#FEF7ED', categoryColor: '#C17F4E', amount: '175g', water: '101', sugar: '5.11', fat: '63.1', pac: '5.11' },
                  { name: 'Sucrose', category: 'Sweetener', categoryBg: '#FDF8E8', categoryColor: '#A08A30', amount: '98g', water: '', sugar: '98', fat: '', pac: '98' },
                  { name: 'Dextrose', category: 'Sweetener', categoryBg: '#FDF8E8', categoryColor: '#A08A30', amount: '80g', water: '', sugar: '70', fat: '', pac: '133' },
                  ...
                  { name: 'Asian Pear, freeze dried', category: 'Flavor', categoryBg: colors.tealLight, categoryColor: colors.tealDark, amount: '60g', water: '', sugar: '26.5', fat: '0.24', pac: '49.9' },
                  { name: 'Goat Cheese', category: 'Flavor', categoryBg: colors.tealLight, categoryColor: colors.tealDark, amount: '100g', water: '45.5', sugar: '', fat: '29.8', pac: '' },
                  { name: 'Stabilizer Mix 4421', category: 'Stabilizer', categoryBg: '#E8F4F2', categoryColor: '#3D8B7D', amount: '8.8g', water: '0.72', sugar: '', fat: '0.02', pac: '0.08' },
                ].map((row, i) => (
          ...
          <div className="space-y-5">
            ...
            <div style={{ backgroundColor: colors.bgCard, borderColor: colors.border }} className="rounded-xl border p-5 shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div style={{ backgroundColor: colors.tealLight }} className="w-11 h-11 rounded-full flex items-center justify-center text-base">
                    ✓
                  </div>
                  <div className="flex-1">
                    <div className="flex justify-between items-baseline">
                      <span className="text-sm font-medium font-sans" style={{ color: colors.textPrimary }}>PAC</span>
                      <span className="text-sm font-medium font-sans" style={{ color: colors.teal }}>232</span>
                    </div>
                    ...
                    <div style={{ backgroundColor: colors.bgCardAlt }} className="h-1.5 rounded-full mt-1.5">
                      <div style={{ backgroundColor: colors.teal }} className="h-full w-4/5 rounded-full" />
                    </div>
                  </div>
                </div>
                
                <div className="flex items-center gap-3">
                  <div style={{ backgroundColor: '#FDF6E8' }} className="w-11 h-11 rounded-full flex items-center justify-center text-base">
                    ↑
                  </div>
                  <div className="flex-1">
                    <div className="flex justify-between items-baseline">
                      <span className="text-sm font-medium font-sans" style={{ color: colors.textPrimary }}>POD</span>
                      <span className="text-sm font-medium font-sans" style={{ color: colors.warningDark }}>121</span>
                    </div>
                    <div className="text-xs font-sans" style={{ color: colors.textMuted }}>Target: 110–120</div>
                    <div style={{ backgroundColor: colors.bgCardAlt }} className="h-1.5 rounded-full mt-1.5">
                      <div style={{ backgroundColor: colors.warning }} className="h-full w-full rounded-full" />
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-baseline">
                      ...
                      <span className="text-sm font-medium font-sans" style={{ color: colors.teal }}>1.92</span>
                    </div>
                    <div className="text-xs font-sans" style={{ color: colors.textMuted }}>Target: 1.8–2.2</div>
                    <div style={{ backgroundColor: colors.bgCardAlt }} className="h-1.5 rounded-full mt-1.5">
                      <div style={{ backgroundColor: colors.teal }} className="h-full w-3/4 rounded-full" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div style={{ backgroundColor: colors.bgCard, borderColor: colors.border }} className="rounded-xl border p-5 shadow-sm">
              ...
              <div className="space-y-2 text-sm font-sans">
                {[
                  { label: 'Water', value: '72.9%', color: '#64B5C6' },
                  { label: 'Solids', value: '27.0%', color: colors.textMuted },
                  { label: 'Sugar', value: '15.5%', color: colors.warning },
                  { label: 'Fat', value: '4.7%', color: '#DDA15E' },
                  { label: 'MSNF', value: '5.7%', color: '#A8A095' },
                  { label: 'Stabilizer', value: '0.19%', color: colors.teal },
                ].map(item => (
            ...
            <div style={{ backgroundColor: colors.bgCard, borderColor: colors.border }} className="rounded-xl border p-5 shadow-sm">
              ...
              <div className="relative h-48">
                <svg viewBox="0 0 200 120" className="w-full h-full">
                  ...
                  <line x1="25" y1="42" x2="190" y2="42" stroke={colors.coral} strokeWidth="1" strokeDasharray="4 2" />
                  <text x="192" y="44" fill={colors.coral} className="text-[7px]">-15°C</text>
                  ...
                  <circle cx="130" cy="42" r="4" fill={colors.teal} />
                  
                  {/* Hardness label */}
                  <text x="130" y="35" textAnchor="middle" fill={colors.tealDark} className="text-[7px] font-medium">75%</text>
                </svg>
              ...
              <div style={{ borderColor: colors.borderLight }} className="flex items-center justify-between mt-3 pt-3 border-t text-xs font-sans">
                <div className="flex items-center gap-2">
                  <div style={{ backgroundColor: colors.coral }} className="w-3 h-0.5" />
                  <span style={{ color: colors.textMuted }}>Serving Temp</span>
                </div>
                <div className="flex items-center gap-2">
                  <div style={{ backgroundColor: colors.teal }} className="w-2 h-2 rounded-full" />
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          {sampleConversation.map((msg, i) => (
            <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
              {msg.role === 'assistant' && (
                <div style={{ background: `linear-gradient(135deg, ${colors.teal} 0%, ${colors.tealDark} 100%)` }} className="w-8 h-8 rounded-lg flex items-center justify-center mr-2 flex-shrink-0">
              ...
              <div 
                ...
                style={{ 
                  backgroundColor: msg.role === 'user' ? colors.teal : colors.bgCardAlt,
