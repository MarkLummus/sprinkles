...
D17 (2026-09-19) settles the connected workspaces and vocabulary in `05-domain-and-language.md`. Apply those terms to the seeds below; they do not add implementation scope. Recipe Sheet and Sheet are synonymous; Adapt starts a distinct recipe, Next version continues one, and Notebook grams preserve imported original quantities and conversion basis.
